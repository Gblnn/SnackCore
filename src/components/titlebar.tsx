...
export default function TitleBar(props:Props){
    ...
    return(
        <div id="base-layer" style={{background:"rgba(240 240 240/ 75%)",backdropFilter:"blur(16px)", height:"5rem", display:"flex", alignItems:"center", boxShadow:"1px 1px 20px rgba(0 0 0/ 50%)", position:"fixed", width:"100%", top:0, zIndex:1, borderBottomLeftRadius:"", borderBottomRightRadius:"" }}>
